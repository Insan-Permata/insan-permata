...
export default function StaffCard({ id, name, photo }: StaffCardProps) {
    return (
        <Link href={`/meet-the-staff/${id}`} className="group relative block w-full aspect-[3/4] rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 ease-out hover:-translate-y-1">
            {/* Photo as Background */}
