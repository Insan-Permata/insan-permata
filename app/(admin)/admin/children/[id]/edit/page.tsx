...
export default function EditChildPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const [interests, setInterests] = useState<string[]>(['reading', 'drawing', 'music']); // Mock data
    ...
    const child = {
        ...
        story: 'Sarah loves reading and drawing. She dreams of becoming an artist.',
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
                ...
                <div>
                    ...
                    <select
                        ...
                        defaultValue={child.educationalStage}
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brown focus:border-transparent"
                    >
                        <option value="-">-</option>
