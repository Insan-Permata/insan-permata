...
export default function EditStaffPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const staff = {
        ...
        name: 'John Smith',
        role: 'Director',
        description: 'John has been serving at Insan Permata for over 10 years, dedicated to providing a loving home for children.',
        bibleVerse: 'Let the little children come to me, and do not hinder them, for the kingdom of heaven belongs to such as these. - Matthew 19:14',
