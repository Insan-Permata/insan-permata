...
export default function EditNewsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const article = {
        ...
        excerpt: 'We are blessed to welcome three new children to our family this month.',
        content: 'This month has been filled with joy as we welcomed three wonderful children to Insan Permata. Each child brings their own unique personality and talents. We are committed to providing them with a loving home, quality education, and spiritual guidance.',
        author: 'John Smith',
